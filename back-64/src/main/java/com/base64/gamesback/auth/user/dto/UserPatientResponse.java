...
public class UserPatientResponse {
    ...
    public UserPatientResponse(UUID userId, String userName, Boolean administrator, String profileImage, String name, String lastname, UUID documentType, String documentTypeCode, String documentNumber, UUID genderType, String genderTypeCode, String phone, String address, String email, String previousTreatments) {
        this.userId = userId;
